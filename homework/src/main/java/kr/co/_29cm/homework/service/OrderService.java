...
public class OrderService {
    ...
    public ReceiptDto checkOrder(HashMap<Long, Integer> orderList, HashMap<Long, Goods> goodsList) throws SoldOutException {
        ...
        ReceiptDto receiptDto = new ReceiptDto(goods, totalPrice);
        return receiptDto;
    }
}
